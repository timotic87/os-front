...
@Component({
  selector: 'app-staffing-cdcm-dialog-v2',
  standalone: true,
  ...
  templateUrl: './staffing-cdcm-dialog-v2.component.html',
  styleUrl: './staffing-cdcm-dialog-v2.component.css'
})
export class StaffingCdcmDialogV2Component implements OnInit {
  ...
  constructor(public rest: RestService, public cdcmService: CDCMService, private dialogService: DialogService, @Inject(MAT_DIALOG_DATA) public deal,
              private dialogRef: MatDialogRef<StaffingCdcmDialogV2Component>, private userService: UserService) {
